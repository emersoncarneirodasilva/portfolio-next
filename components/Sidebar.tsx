  ...
  return (
    <>
      ...
      <h3 className="my-4 text-3xl font-medium tracking-wider font-kaushan">
        <span className="text-azul">Emerson</span> C. da Silva
      </h3>
      ...
      {/* Botão do email */}
      <button 
        className="w-9/12 px-5 py-2 text-white bg-black rounded-full cursor-pointer bg-gradient-to-r from-roxo to-roxo2 hover:scale-105 focus:outline-none"
        onClick={() => window.open('mailto:mersiocarneiro87@gmail.com')}>
        Email
      </button>
      <button 
        onClick={changeTheme}
        className="w-9/12 px-5 py-2 my-4 text-white bg-black rounded-full cursor-pointer bg-gradient-to-r from-roxo to-roxo2 focus:outline-none hover:scale-105">
        Mudar Tema
      </button>
    </>    
  )
