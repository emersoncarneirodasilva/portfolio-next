      ...
      <div className="grid gap-6 md:grid-cols-2">        
        <motion.div variants={fadeInUp} initial="initial" animate="animate">
          ...
          <div>
            ...
            <p className="my-3">Sou mestre em química pela Universidade Federal do Rio Grande do Norte.</p>
          </div>
        </motion.div>
        {/* Experiência */}
        <motion.div variants={fadeInUp} initial="initial" animate="animate">
          ...
          <div>
            ...
            <p className="font-semibold">UFRN (2016-2018)</p>
            <p className="my-3">Extração de metais em placas de circuitos impressos obsoletas através de reações com ácidos, bases e processos eletroquímicos.</p>
          </div>
        </motion.div>
