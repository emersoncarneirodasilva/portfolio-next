...
export const services: IService[] = [
  ...
  },
  {
    ...
    about:
      "Trabalho <strong>harmonizando</strong> a estrutura da página, <strong>equilibrando</strong> elementos visuais, em <strong>diferentes dispositivos</strong>.",
  },
  {
    Icon: BiTargetLock,
    title: "SEO",
...
export const projects: IProject[] = [
  ...
  },
  {
    id: 3,
    name: "Buscador Cep",
    description: "Projeto de localização de endereço a partir do CEP.",
  ...
  },
  {
    id: 4,
    name: "Meu Link",
    description: "Projeto de um encurtador de links feito com React.JS.",
  ...
  },
  {
    ...
    description: "Projeto de uma calculadora IMC utilizando React.JS.",
  ...
  },
  {
    id: 7,
    name: "Jogo Genius",
    description: "Recriando jogo Genius utilizando HTML, CSS e JavaScript.",
  ...
  },
  {
    id: 8,
    name: "Relógio Glass",
    description: "Projeto criado com HTML, CSS e JavaScript.",
  ...
  },
  {
    ...
    description: "Site recriado utilizando HTML, CSS e JavaScript.",
    image_path: "/images/food02.png",
    deployed_url:
      "https://emersoncarneirodasilva.github.io/website_restaurant/",
  ...
  },
  {
    ...
    description: "Landing page recriada utilizando HTML, CSS e JavaScript.",
  ...
  },
  {
    ...
    description: "Recriando o site Netflix utilizando HTML, CSS e jQuery.",
  ...
  },
  {
    id: 14,
    name: "Amazing Clock",
    description: "Relógio incrível (amazing clock) construído com HTML e CSS.",
  ...
  },
  {
    ...
    description: "Currículo criado utilizando HTML, CSS.",
